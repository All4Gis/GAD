...
class Ui_DimStyle_Details_Dialog(object):
    def setupUi(self, DimStyle_Details_Dialog):
        ...
        self.dimLineOffsetExtLine = QtGui.QDoubleSpinBox(self.groupBox)
        ...
        self.dimLineOffsetExtLine.setObjectName(_fromUtf8("dimLineOffsetExtLine"))
        ...
        self.groupBox_11 = QtGui.QGroupBox(self.SymbolTab)
        self.groupBox_11.setGeometry(QtCore.QRect(10, 190, 271, 81))
        self.groupBox_11.setObjectName(_fromUtf8("groupBox_11"))
        self.centerMarkNone = QtGui.QRadioButton(self.groupBox_11)
        self.centerMarkNone.setGeometry(QtCore.QRect(10, 20, 82, 17))
        self.centerMarkNone.setObjectName(_fromUtf8("centerMarkNone"))
        self.centerMarkMark = QtGui.QRadioButton(self.groupBox_11)
        self.centerMarkMark.setGeometry(QtCore.QRect(10, 40, 82, 17))
        self.centerMarkMark.setObjectName(_fromUtf8("centerMarkMark"))
        self.centerMarkLine = QtGui.QRadioButton(self.groupBox_11)
        self.centerMarkLine.setGeometry(QtCore.QRect(10, 60, 82, 17))
        self.centerMarkLine.setObjectName(_fromUtf8("centerMarkLine"))
        self.centerMarkLength = QtGui.QDoubleSpinBox(self.groupBox_11)
        ...
        self.centerMarkLength.setObjectName(_fromUtf8("centerMarkLength"))
        ...
        QtCore.QObject.connect(self.dimLineOffsetExtLine, QtCore.SIGNAL(_fromUtf8("valueChanged(double)")), DimStyle_Details_Dialog.dimLineOffsetExtLineChanged)
        QtCore.QObject.connect(self.centerMarkNone, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), DimStyle_Details_Dialog.centerMarkNoneChanged)
        QtCore.QObject.connect(self.centerMarkMark, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), DimStyle_Details_Dialog.centerMarkMarkChanged)
        QtCore.QObject.connect(self.centerMarkLine, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), DimStyle_Details_Dialog.centerMarkLineChanged)
        QtCore.QObject.connect(self.centerMarkLength, QtCore.SIGNAL(_fromUtf8("valueChanged(double)")), DimStyle_Details_Dialog.centerMarkLengthChanged)
    ...
    def retranslateUi(self, DimStyle_Details_Dialog):
        ...
        self.label_41.setText(_translate("DimStyle_Details_Dialog", "Extend beyond ticks:", None))
        self.dimLineOffsetExtLine.setToolTip(_translate("DimStyle_Details_Dialog", "Specifies a distance to extend the dimension line above the extension lines.", None))
        ...
        self.arcSymbolPreceding.setToolTip(_translate("DimStyle_Details_Dialog", "Places arc length symbols before the dimension text.", None))
        self.arcSymbolPreceding.setText(_translate("DimStyle_Details_Dialog", "Preceding dimension text", None))
        self.arcSymbolAbove.setToolTip(_translate("DimStyle_Details_Dialog", "Places arc length symbols above the dimension text.", None))
        self.arcSymbolAbove.setText(_translate("DimStyle_Details_Dialog", "Above dimension text", None))
        self.arcSymbolNone.setToolTip(_translate("DimStyle_Details_Dialog", "Suppresses the display of arc length symbols.", None))
        self.arcSymbolNone.setText(_translate("DimStyle_Details_Dialog", "None", None))
        self.groupBox_11.setTitle(_translate("DimStyle_Details_Dialog", "Center marks", None))
        self.centerMarkNone.setToolTip(_translate("DimStyle_Details_Dialog", "Creates no center mark or centerline.", None))
        self.centerMarkNone.setText(_translate("DimStyle_Details_Dialog", "None", None))
        self.centerMarkMark.setToolTip(_translate("DimStyle_Details_Dialog", "Creates a center mark.", None))
        self.centerMarkMark.setText(_translate("DimStyle_Details_Dialog", "Mark", None))
        self.centerMarkLine.setToolTip(_translate("DimStyle_Details_Dialog", "Creates a centerline.", None))
        self.centerMarkLine.setText(_translate("DimStyle_Details_Dialog", "Line", None))
        self.centerMarkLength.setToolTip(_translate("DimStyle_Details_Dialog", "Size of the center mark or centerline.", None))
